...
export const ContactChatSection: React.FC<ContactChatSectionProps> = ({
  onOpenResume,
}) => {
  // Contact Form State
  ...
  // Send message to OpenRouter endpoint (/api/chat)
  const handleSendMessage = async (textToSend?: string) => {
    const messageText = textToSend || inputMessage;

    if (!messageText.trim() || isChatLoading) {
      return;
    }
    ...
    try {
      ...
      const errorMsg: ChatMessage = {
        ...
        sender: 'assistant',
        text:
          '네트워크 연결 상태를 확인해주세요. 직접 연락을 원하시면 leeony@naver.com 으로 메일을 보내주세요.',
        timestamp: new Date().toLocaleTimeString([], {
          hour: '2-digit',
          minute: '2-digit',
        }),
    ...
    <section className="mb-12">
      ...
      <div className="flex flex-col gap-2 mb-8">
        ...
        <p className="text-xs text-gray-400 ml-4.5 tracking-wider uppercase font-medium">
          Get in Touch & Ask About Ha Ju-seong
        </p>
      </div>
        ...
        <div className="lg:col-span-5 glass-card p-6 md:p-8 flex flex-col justify-between space-y-6">
          <div>
            ...
            <p className="text-xs text-gray-400 mb-6 leading-relaxed">
              AI 프로젝트, 협업, 채용 및 개발 관련 문의를 환영합니다.
              확인 후 회신드립니다.
            </p>
            ...
            {formSubmitted ? (
              <div className="p-6 bg-blue-950/40 border border-blue-500/30 rounded-2xl text-center space-y-3">
                ...
                <p className="text-xs text-gray-300">
                  남겨주신 이메일({formData.email})로 확인 후
                  답변드리겠습니다.
                </p>
              ...
              >
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3.5 py-2.5 bg-gray-900 border border-white/10 rounded-xl text-xs text-white focus:outline-none focus:border-blue-500"
                  >
                    <option value="협업 및 프로젝트 문의">
                      협업 및 프로젝트 문의
                    </option>

                    <option value="채용 / 입사 제안">
                      채용 / 입사 제안
                    </option>

                    <option value="AI 프로젝트 협업">
                      AI 프로젝트 협업
                    </option>
        ...
        <div className="lg:col-span-7 glass-card p-6 flex flex-col justify-between min-h-[550px] relative border-blue-500/30">
                ...
                setChatMessages([
                  {
                    ...
                    sender: 'assistant',
                    text:
                      '대화가 초기화되었습니다. 궁금한 사항을 편하게 질문해 주세요! ⚡',
                    timestamp: new Date().toLocaleTimeString(
                      [],
                      {
                        hour: '2-digit',
          ...
          <div className="pt-2 flex items-center gap-2">
            <input
              ...
              placeholder="하주성에 대해 궁금한 내용을 입력하세요..."
